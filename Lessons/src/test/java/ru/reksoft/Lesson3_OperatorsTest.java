...
class Lesson3_OperatorsTest {
    ...
    @Test
    void task1() {
        Assert.assertEquals("1, abcde → abcde1", Lesson3_Operators.task1(1, "abcde"), "abcde1");
        Assert.assertEquals("-1, abcde → -1abcde", Lesson3_Operators.task1(-1, "abcde"), "-1abcde");
        Assert.assertEquals("11223344, abcde → abcde11223", Lesson3_Operators.task1(11223344, "abcde"), "abcde11223344");
        Assert.assertEquals("-12345, abcde → -12345abcd", Lesson3_Operators.task1(-12345, "abcde"), "-12345abcde");
        Assert.assertEquals("0, abcde → 0", Lesson3_Operators.task1(0, "abcde"), "0");
        Assert.assertEquals("4, 123 → 1234", Lesson3_Operators.task1(4, "123"), "1234");
    }

    @Test
    void task2() {
        Assert.assertTrue("45 → true", Lesson3_Operators.task2(45));
